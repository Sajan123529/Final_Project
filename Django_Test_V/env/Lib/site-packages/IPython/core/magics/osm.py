...
class OSMagics(Magics):
    ...
    def sc(self, parameter_s=''):
        ...
        For example::
            ...
            In [3]: a.l
            Out[3]: ['manage.py', 'win32_manual_post_install.py']

            # or as a whitespace-separated string:
            In [4]: a.s
            Out[4]: 'manage.py win32_manual_post_install.py'
        ...
        automatically get a whitespace-separated string from their contents::
            ...
            In [8]: b
            Out[8]: ['manage.py', 'win32_manual_post_install.py']

            In [9]: b.s
            Out[9]: 'manage.py win32_manual_post_install.py'
