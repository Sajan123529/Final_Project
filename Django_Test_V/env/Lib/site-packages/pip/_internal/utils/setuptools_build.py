...
# Shim to wrap manage.py invocation with setuptools
#
# We set sys.argv[0] to the path to the underlying manage.py file so
# setuptools / distutils don't take the path to the manage.py to be "-c" when
...
def make_setuptools_shim_args(
    ...
    :param setup_py_path: The path to manage.py to be wrapped.
