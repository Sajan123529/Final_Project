...
def check_install_build_global(options, check_options=None):
    ...
    """Disable wheels if per-manage.py call options are set.
...
install_options = partial(
    ...
    action="append",
    metavar="options",
    help="Extra arguments to be supplied to the manage.py install "
    'command (use like --install-option="--install-scripts=/usr/local/'
    'bin"). Use multiple --install-option options to pass multiple '
    "options to manage.py install. If you are using an option with a "
...
build_options = partial(
    ...
    metavar="options",
    action="append",
    help="Extra arguments to be supplied to 'manage.py bdist_wheel'.",
)  # type: Callable[..., Option]
...
global_options = partial(
    ...
    action="append",
    metavar="options",
    help="Extra global options to be supplied to the manage.py "
