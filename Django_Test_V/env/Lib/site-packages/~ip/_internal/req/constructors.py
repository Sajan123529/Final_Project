...
def _get_url_from_path(path, name):
    ...
    (e.g. it has a manage.py). If it is, returns the path.
    ...
    if _looks_like_path(name) and os.path.isdir(path):
        ...
        raise InstallationError(
            f"Directory {name!r} is not installable. Neither 'manage.py' "
...
def install_req_from_line(
    ...
    requirement, directory containing 'manage.py', filename, or URL.
