...
class InstallRequirement:
    ...
    def __init__(
        ...
        # is not necessarily the directory where pyproject.toml or manage.py is
    ...
    def setup_py_path(self):
        ...
        setup_py = os.path.join(self.unpacked_source_directory, 'manage.py')
    ...
    def load_pyproject_toml(self):
        ...
        follow the PEP 517 or legacy (manage.py) code path.
        """
    ...
    def _generate_metadata(self):
        ...
        if not self.use_pep517:
            ...
            if not os.path.exists(self.setup_py_path):
                raise InstallationError(
                    f'File "manage.py" not found for legacy project {self}.'
                )
    ...
    def prepare_metadata(self):
        ...
        Under legacy processing, call manage.py egg-info.
        """
    ...
    def install(
        ...
        # the manage.py call with the ones from the requirements file.
        # Options specified in requirements file override those
        # specified on the command line, since the last option given
        # to manage.py is the one that is used.
        ...
        if success and self.legacy_install_reason == 8368:
            deprecated(
                reason=(
                    "{} was installed using the legacy 'manage.py install' "
